...
Este projeto é um portfólio moderno desenvolvido com **React** e **Vite**, focado em performance, modularidade e uma experiência de usuário fluida. A aplicação apresenta minhas competências, projetos e meios de contato de forma organizada.
...
# 5. Para verificar erros de Lint (Padronização de código)
npm run lint
